...
```{r}
ttestResult = t.test(NHANES_sample$BMI[NHANES_sample$PhysActive=='No'],NHANES_sample$BMI[NHANES_sample$PhysActive=='Yes'],var.equal=TRUE,alternative='greater')
print(ttestResult)
...
```{r}
ttestResult = t.test(NHANES_sample$BMI[NHANES_sample$PhysActive=='No'],NHANES_sample$BMI[NHANES_sample$PhysActive=='Yes'],var.equal=TRUE)
print(ttestResult)
