...
What's the probability for being each combination of unhealthy/health and over 70/ not. 
```{r}
pBoth <- healthDf %>% 
...
#Finally, probability of someone being unhealthy, given that they are over 70 years of age
```{r}
